...
from ...types.payments import domestic_ach_params, domestic_rtp_params, domestic_wire_params
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                domestic_ach_params.DomesticACHParams,
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                domestic_rtp_params.DomesticRtpParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                domestic_wire_params.DomesticWireParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class DomesticResourceWithRawResponse:
    def __init__(self, domestic: DomesticResource) -> None:
        ...
        self.ach = to_raw_response_wrapper(
            domestic.ach,
        )
        self.rtp = to_raw_response_wrapper(
            domestic.rtp,
        )
        self.wire = to_raw_response_wrapper(
            domestic.wire,
        )
...
class AsyncDomesticResourceWithRawResponse:
    def __init__(self, domestic: AsyncDomesticResource) -> None:
        ...
        self.ach = async_to_raw_response_wrapper(
            domestic.ach,
        )
        self.rtp = async_to_raw_response_wrapper(
            domestic.rtp,
        )
        self.wire = async_to_raw_response_wrapper(
            domestic.wire,
        )
...
class DomesticResourceWithStreamingResponse:
    def __init__(self, domestic: DomesticResource) -> None:
        ...
        self.ach = to_streamed_response_wrapper(
            domestic.ach,
        )
        self.rtp = to_streamed_response_wrapper(
            domestic.rtp,
        )
        self.wire = to_streamed_response_wrapper(
            domestic.wire,
        )
...
class AsyncDomesticResourceWithStreamingResponse:
    def __init__(self, domestic: AsyncDomesticResource) -> None:
        ...
        self.ach = async_to_streamed_response_wrapper(
            domestic.ach,
        )
        self.rtp = async_to_streamed_response_wrapper(
            domestic.rtp,
        )
        self.wire = async_to_streamed_response_wrapper(
            domestic.wire,
        )
