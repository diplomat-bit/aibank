...
from ...types.payments import domestic_send_ach_params, domestic_send_rtp_params, domestic_send_wire_params
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                domestic_send_ach_params.DomesticSendACHParams,
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                domestic_send_rtp_params.DomesticSendRtpParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                domestic_send_wire_params.DomesticSendWireParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class DomesticResourceWithRawResponse:
    def __init__(self, domestic: DomesticResource) -> None:
        ...
        self.send_ach = to_raw_response_wrapper(
            domestic.send_ach,
        )
        self.send_rtp = to_raw_response_wrapper(
            domestic.send_rtp,
        )
        self.send_wire = to_raw_response_wrapper(
            domestic.send_wire,
        )
...
class AsyncDomesticResourceWithRawResponse:
    def __init__(self, domestic: AsyncDomesticResource) -> None:
        ...
        self.send_ach = async_to_raw_response_wrapper(
            domestic.send_ach,
        )
        self.send_rtp = async_to_raw_response_wrapper(
            domestic.send_rtp,
        )
        self.send_wire = async_to_raw_response_wrapper(
            domestic.send_wire,
        )
...
class DomesticResourceWithStreamingResponse:
    def __init__(self, domestic: DomesticResource) -> None:
        ...
        self.send_ach = to_streamed_response_wrapper(
            domestic.send_ach,
        )
        self.send_rtp = to_streamed_response_wrapper(
            domestic.send_rtp,
        )
        self.send_wire = to_streamed_response_wrapper(
            domestic.send_wire,
        )
...
class AsyncDomesticResourceWithStreamingResponse:
    def __init__(self, domestic: AsyncDomesticResource) -> None:
        ...
        self.send_ach = async_to_streamed_response_wrapper(
            domestic.send_ach,
        )
        self.send_rtp = async_to_streamed_response_wrapper(
            domestic.send_rtp,
        )
        self.send_wire = async_to_streamed_response_wrapper(
            domestic.send_wire,
        )
