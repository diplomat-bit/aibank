...
from ...types.sustainability import offset_retire_params, offset_purchase_params
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                offset_purchase_params.OffsetPurchaseParams,
            ),
    ...
    def retire(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"certificate_id": certificate_id}, offset_retire_params.OffsetRetireParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    async def retire(
        ...
        *,
        ...
        return await self._post(
            "/sustainability/offsets/retire",
            body=await async_maybe_transform(
                {"certificate_id": certificate_id}, offset_retire_params.OffsetRetireParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class OffsetsResourceWithRawResponse:
    def __init__(self, offsets: OffsetsResource) -> None:
        ...
        self.retire = to_raw_response_wrapper(
            offsets.retire,
        )
...
class AsyncOffsetsResourceWithRawResponse:
    def __init__(self, offsets: AsyncOffsetsResource) -> None:
        ...
        self.retire = async_to_raw_response_wrapper(
            offsets.retire,
        )
...
class OffsetsResourceWithStreamingResponse:
    def __init__(self, offsets: OffsetsResource) -> None:
        ...
        self.retire = to_streamed_response_wrapper(
            offsets.retire,
        )
...
class AsyncOffsetsResourceWithStreamingResponse:
    def __init__(self, offsets: AsyncOffsetsResource) -> None:
        ...
        self.retire = async_to_streamed_response_wrapper(
            offsets.retire,
        )
