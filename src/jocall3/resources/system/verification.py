...
from ...types.system import verification_document_params, verification_biometric_match_params
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                verification_biometric_match_params.VerificationBiometricMatchParams,
            ),
    ...
    def document(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(body, verification_document_params.VerificationDocumentParams),
            files=files,
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncVerificationResource(AsyncAPIResource):
    ...
    async def document(
        ...
        *,
        ...
        return await self._post(
            "/system/verification/document",
            body=await async_maybe_transform(body, verification_document_params.VerificationDocumentParams),
            files=files,
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class VerificationResourceWithRawResponse:
    def __init__(self, verification: VerificationResource) -> None:
        ...
        self.biometric_match = to_raw_response_wrapper(
...
class AsyncVerificationResourceWithRawResponse:
    def __init__(self, verification: AsyncVerificationResource) -> None:
        ...
        self.biometric_match = async_to_raw_response_wrapper(
            verification.biometric_match,
        )
...
class VerificationResourceWithStreamingResponse:
    def __init__(self, verification: VerificationResource) -> None:
        ...
        self.biometric_match = to_streamed_response_wrapper(
            verification.biometric_match,
        )
...
class AsyncVerificationResourceWithStreamingResponse:
    def __init__(self, verification: AsyncVerificationResource) -> None:
        ...
        self.biometric_match = async_to_streamed_response_wrapper(
            verification.biometric_match,
        )
