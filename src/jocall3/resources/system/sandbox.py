...
from ...types.system import sandbox_force_error_params
from ...types.system.sandbox_force_error_response import SandboxForceErrorResponse
    ...
    def force_error(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"error_code": error_code}, sandbox_force_error_params.SandboxForceErrorParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SandboxForceErrorResponse,
        )
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"error_code": error_code}, sandbox_force_error_params.SandboxForceErrorParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class SandboxResourceWithRawResponse:
    def __init__(self, sandbox: SandboxResource) -> None:
        ...
        self.force_error = to_raw_response_wrapper(
            sandbox.force_error,
        )
...
class AsyncSandboxResourceWithRawResponse:
    def __init__(self, sandbox: AsyncSandboxResource) -> None:
        ...
        self.force_error = async_to_raw_response_wrapper(
            sandbox.force_error,
        )
...
class SandboxResourceWithStreamingResponse:
    def __init__(self, sandbox: SandboxResource) -> None:
        ...
        self.force_error = to_streamed_response_wrapper(
            sandbox.force_error,
        )
...
class AsyncSandboxResourceWithStreamingResponse:
    def __init__(self, sandbox: AsyncSandboxResource) -> None:
        ...
        self.force_error = async_to_streamed_response_wrapper(
            sandbox.force_error,
        )
