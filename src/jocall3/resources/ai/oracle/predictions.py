...
from ....types.ai.oracle import prediction_retrieve_inflation_forecast_params
from ....types.ai.oracle.prediction_retrieve_inflation_forecast_response import (
...
class PredictionsResource(SyncAPIResource):
    ...
    def retrieve_inflation_forecast(
        self,
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"region": region},
                    prediction_retrieve_inflation_forecast_params.PredictionRetrieveInflationForecastParams,
                ),
            ),
            cast_to=PredictionRetrieveInflationForecastResponse,
        )
...
class AsyncPredictionsResource(AsyncAPIResource):
    ...
    async def retrieve_inflation_forecast(
        self,
        *,
        region: str | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
...
class PredictionsResourceWithRawResponse:
    def __init__(self, predictions: PredictionsResource) -> None:
        ...
        self.retrieve_inflation_forecast = to_raw_response_wrapper(
            predictions.retrieve_inflation_forecast,
        )
...
class AsyncPredictionsResourceWithRawResponse:
    def __init__(self, predictions: AsyncPredictionsResource) -> None:
        ...
        self.retrieve_inflation_forecast = async_to_raw_response_wrapper(
            predictions.retrieve_inflation_forecast,
        )
...
class PredictionsResourceWithStreamingResponse:
    def __init__(self, predictions: PredictionsResource) -> None:
        ...
        self.retrieve_inflation_forecast = to_streamed_response_wrapper(
            predictions.retrieve_inflation_forecast,
        )
...
class AsyncPredictionsResourceWithStreamingResponse:
    def __init__(self, predictions: AsyncPredictionsResource) -> None:
        ...
        self.retrieve_inflation_forecast = async_to_streamed_response_wrapper(
            predictions.retrieve_inflation_forecast,
        )
