...
from ....types.ai.advisor_chat_response import AdvisorChatResponse
from ....types.ai.advisor_retrieve_history_response import AdvisorRetrieveHistoryResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                advisor_chat_params.AdvisorChatParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=AdvisorChatResponse,
        )
    ...
    def retrieve_history(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=AdvisorRetrieveHistoryResponse,
        )
