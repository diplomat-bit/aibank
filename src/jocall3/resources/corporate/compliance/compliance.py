...
from ....types.corporate import (
    ...
    compliance_screen_adverse_media_params,
)
...
from ....types.corporate.compliance_screen_adverse_media_response import ComplianceScreenAdverseMediaResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                compliance_screen_adverse_media_params.ComplianceScreenAdverseMediaParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ComplianceScreenAdverseMediaResponse,
        )
...
class ComplianceResourceWithRawResponse:
    def __init__(self, compliance: ComplianceResource) -> None:
        ...
        self.screen_adverse_media = to_raw_response_wrapper(
            compliance.screen_adverse_media,
        )
...
class AsyncComplianceResourceWithRawResponse:
    def __init__(self, compliance: AsyncComplianceResource) -> None:
        ...
        self.screen_adverse_media = async_to_raw_response_wrapper(
            compliance.screen_adverse_media,
        )
...
class ComplianceResourceWithStreamingResponse:
    def __init__(self, compliance: ComplianceResource) -> None:
        ...
        self.screen_adverse_media = to_streamed_response_wrapper(
            compliance.screen_adverse_media,
        )
...
class AsyncComplianceResourceWithStreamingResponse:
    def __init__(self, compliance: AsyncComplianceResource) -> None:
        ...
        self.screen_adverse_media = async_to_streamed_response_wrapper(
            compliance.screen_adverse_media,
        )
