...
from ....types.corporate.treasury import sweeping_execute_params, sweeping_configure_params
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                sweeping_configure_params.SweepingConfigureParams,
            ),
    ...
    def execute(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"rule_id": rule_id}, sweeping_execute_params.SweepingExecuteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncSweepingResource(AsyncAPIResource):
    ...
    async def execute(
        ...
        *,
        ...
        return await self._post(
            "/corporate/treasury/sweeping/execute",
            body=await async_maybe_transform({"rule_id": rule_id}, sweeping_execute_params.SweepingExecuteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
