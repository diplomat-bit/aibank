...
from ....types.corporate import risk_stress_test_params
from ....types.corporate.risk_stress_test_response import RiskStressTestResponse
from ....types.corporate.risk_get_exposure_response import RiskGetExposureResponse
    ...
    def get_exposure(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=RiskGetExposureResponse,
        )
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                risk_stress_test_params.RiskStressTestParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=RiskStressTestResponse,
        )
...
class RiskResourceWithRawResponse:
    def __init__(self, risk: RiskResource) -> None:
        ...
        self.get_exposure = to_raw_response_wrapper(
            risk.get_exposure,
        )
        self.stress_test = to_raw_response_wrapper(
            risk.stress_test,
        )
...
class AsyncRiskResourceWithRawResponse:
    def __init__(self, risk: AsyncRiskResource) -> None:
        ...
        self.get_exposure = async_to_raw_response_wrapper(
            risk.get_exposure,
        )
        self.stress_test = async_to_raw_response_wrapper(
            risk.stress_test,
        )
...
class RiskResourceWithStreamingResponse:
    def __init__(self, risk: RiskResource) -> None:
        ...
        self.get_exposure = to_streamed_response_wrapper(
            risk.get_exposure,
        )
        self.stress_test = to_streamed_response_wrapper(
            risk.stress_test,
        )
...
class AsyncRiskResourceWithStreamingResponse:
    def __init__(self, risk: AsyncRiskResource) -> None:
        ...
        self.get_exposure = async_to_streamed_response_wrapper(
            risk.get_exposure,
        )
        self.stress_test = async_to_streamed_response_wrapper(
            risk.stress_test,
        )
