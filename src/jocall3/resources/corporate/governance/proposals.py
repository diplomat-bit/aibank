...
from ....types.corporate.governance import proposal_vote_params, proposal_create_params
from ....types.corporate.governance.proposal_list_response import ProposalListResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                proposal_create_params.ProposalCreateParams,
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                proposal_vote_params.ProposalVoteParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
