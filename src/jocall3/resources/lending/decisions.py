...
from ...types.lending.decision_retrieve_rationale_response import DecisionRetrieveRationaleResponse
...
class DecisionsResource(SyncAPIResource):
    ...
    def retrieve_rationale(
        ...
        *,
    ...
    ) -> DecisionRetrieveRationaleResponse:
        """
        ...
        return self._get(
            ...
            cast_to=DecisionRetrieveRationaleResponse,
        )
...
class DecisionsResourceWithRawResponse:
    def __init__(self, decisions: DecisionsResource) -> None:
        ...
        self.retrieve_rationale = to_raw_response_wrapper(
            decisions.retrieve_rationale,
        )
...
class AsyncDecisionsResourceWithRawResponse:
    def __init__(self, decisions: AsyncDecisionsResource) -> None:
        ...
        self.retrieve_rationale = async_to_raw_response_wrapper(
            decisions.retrieve_rationale,
        )
...
class DecisionsResourceWithStreamingResponse:
    def __init__(self, decisions: DecisionsResource) -> None:
        ...
        self.retrieve_rationale = to_streamed_response_wrapper(
            decisions.retrieve_rationale,
        )
...
class AsyncDecisionsResourceWithStreamingResponse:
    def __init__(self, decisions: AsyncDecisionsResource) -> None:
        ...
        self.retrieve_rationale = async_to_streamed_response_wrapper(
            decisions.retrieve_rationale,
        )
