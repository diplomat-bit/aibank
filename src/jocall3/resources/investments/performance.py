...
from ...types.investments import performance_retrieve_historical_params
from ...types.investments.performance_retrieve_historical_response import PerformanceRetrieveHistoricalResponse
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"range": range}, performance_retrieve_historical_params.PerformanceRetrieveHistoricalParams
                ),
            ),
            cast_to=PerformanceRetrieveHistoricalResponse,
        )
...
class PerformanceResourceWithRawResponse:
    def __init__(self, performance: PerformanceResource) -> None:
        ...
        self.retrieve_historical = to_raw_response_wrapper(
            performance.retrieve_historical,
        )
