...
- <code title="post /ai/oracle/simulate/monte-carlo">client.ai.oracle.simulate.<a href="./src/jocall3/resources/ai/oracle/simulate.py">run_monte_carlo</a>(\*\*<a href="src/jocall3/types/ai/oracle/simulate_run_monte_carlo_params.py">params</a>) -> <a href="./src/jocall3/types/ai/oracle/simulate_run_monte_carlo_response.py">SimulateRunMonteCarloResponse</a></code>
...
```python
from jocall3.types.ai import IncubatorGeneratePitchResponse, IncubatorValidateIdeaResponse
```
