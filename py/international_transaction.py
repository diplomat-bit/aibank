...
class InternationalTransaction(object):
    ...
    def __init__(
        self,
        atm_transaction_limit_toggle_indicator=None,
        atm_transaction_limit_amount=None,
        contactless_txn_limit_toggle_indicator=None,
        contactless_transaction_limit_amount=None,
        contact_pos_txn_limit_toggle_indicator=None,
        contact_pos_transaction_limit_amount=None,
        non_pos_txn_limit_toggle_indicator=None,
        non_pos_transaction_limit_amount=None,
    ):  # noqa: E501
        ...
        if atm_transaction_limit_toggle_indicator is not None:
            self.atm_transaction_limit_toggle_indicator = (
                atm_transaction_limit_toggle_indicator
            )
        ...
        if contactless_txn_limit_toggle_indicator is not None:
            self.contactless_txn_limit_toggle_indicator = (
                contactless_txn_limit_toggle_indicator
            )
        if contactless_transaction_limit_amount is not None:
            self.contactless_transaction_limit_amount = (
                contactless_transaction_limit_amount
            )
        if contact_pos_txn_limit_toggle_indicator is not None:
            self.contact_pos_txn_limit_toggle_indicator = (
                contact_pos_txn_limit_toggle_indicator
            )
        if contact_pos_transaction_limit_amount is not None:
            self.contact_pos_transaction_limit_amount = (
                contact_pos_transaction_limit_amount
            )
    ...
    def atm_transaction_limit_toggle_indicator(
        self, atm_transaction_limit_toggle_indicator
    ):
        ...
        self._atm_transaction_limit_toggle_indicator = (
            atm_transaction_limit_toggle_indicator
        )
    ...
    def contactless_txn_limit_toggle_indicator(
        self, contactless_txn_limit_toggle_indicator
    ):
        ...
        self._contactless_txn_limit_toggle_indicator = (
            contactless_txn_limit_toggle_indicator
        )
    ...
    def contactless_transaction_limit_amount(
        self, contactless_transaction_limit_amount
    ):
        ...
        self._contactless_transaction_limit_amount = (
            contactless_transaction_limit_amount
        )
    ...
    def contact_pos_txn_limit_toggle_indicator(
        self, contact_pos_txn_limit_toggle_indicator
    ):
        ...
        self._contact_pos_txn_limit_toggle_indicator = (
            contact_pos_txn_limit_toggle_indicator
        )
    ...
    def contact_pos_transaction_limit_amount(
        self, contact_pos_transaction_limit_amount
    ):
        ...
        self._contact_pos_transaction_limit_amount = (
            contact_pos_transaction_limit_amount
        )
