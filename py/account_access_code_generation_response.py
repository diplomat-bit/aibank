...
class AccountAccessCodeGenerationResponse(object):
    ...
    """
    swagger_types = {"account_access_code": "str", "access_url": "str"}
    ...
    def account_access_code(self, account_access_code):
        ...
        if account_access_code is None:
            raise ValueError(
                "Invalid value for `account_access_code`, must not be `None`"
            )  # noqa: E501
    ...
    def access_url(self, access_url):
        ...
        if access_url is None:
            raise ValueError(
                "Invalid value for `access_url`, must not be `None`"
            )  # noqa: E501
