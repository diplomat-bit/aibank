...
class RetrieveApplicationProcessingUnsecuredLoanTopupRepaymentScheduleResponse(object):
    ...
    def __init__(
        ...
        effective_interest_rate_with_fee=None,
        annual_percentage_rate=None,
        loan_schedule_details=None,
        loan_topup=None,
    ):  # noqa: E501
    ...
    def fixed_payment_amount(self, fixed_payment_amount):
        ...
        if fixed_payment_amount is None:
            raise ValueError(
                "Invalid value for `fixed_payment_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def total_interest_amount(self, total_interest_amount):
        ...
        if total_interest_amount is None:
            raise ValueError(
                "Invalid value for `total_interest_amount`, must not be `None`"
            )  # noqa: E501
