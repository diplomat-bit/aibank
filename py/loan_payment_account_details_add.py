...
class LoanPaymentAccountDetailsAdd(object):
    ...
    def __init__(
        ...
        loan_disbursement_method=None,
        account_number=None,
        account_reference_key=None,
        account_nick_name=None,
        bank_name=None,
        bank_code=None,
        branch_code=None,
    ):  # noqa: E501
    ...
    def bank_name(self, bank_name):
        ...
        if bank_name is None:
            raise ValueError(
                "Invalid value for `bank_name`, must not be `None`"
            )  # noqa: E501
    ...
    def branch_code(self, branch_code):
        ...
        if branch_code is None:
            raise ValueError(
                "Invalid value for `branch_code`, must not be `None`"
            )  # noqa: E501
