...
class RewardsApi(object):
    ...
    def v1_credit_cards_rewards_point_balance_search_post(
        ...
        if kwargs.get("async_req"):
            return (
                self.v1_credit_cards_rewards_point_balance_search_post_with_http_info(
    ...
    def v1_credit_cards_rewards_point_balance_search_post_with_http_info(
        self, body, authorization, uuid, accept, client_id, content_type, **kwargs
    ):  # noqa: E501
        """This API is used to retrieve reward points balance for multiple credit cards  # noqa: E501
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `v1_credit_cards_rewards_point_balance_search_post`"
            )  # noqa: E501
        # verify the required parameter 'authorization' is set
        if "authorization" not in params or params["authorization"] is None:
            raise ValueError(
                "Missing the required parameter `authorization` when calling `v1_credit_cards_rewards_point_balance_search_post`"
            )  # noqa: E501
        # verify the required parameter 'uuid' is set
        if "uuid" not in params or params["uuid"] is None:
            raise ValueError(
                "Missing the required parameter `uuid` when calling `v1_credit_cards_rewards_point_balance_search_post`"
            )  # noqa: E501
        # verify the required parameter 'accept' is set
        if "accept" not in params or params["accept"] is None:
            raise ValueError(
                "Missing the required parameter `accept` when calling `v1_credit_cards_rewards_point_balance_search_post`"
            )  # noqa: E501
        # verify the required parameter 'client_id' is set
        if "client_id" not in params or params["client_id"] is None:
            raise ValueError(
                "Missing the required parameter `client_id` when calling `v1_credit_cards_rewards_point_balance_search_post`"
            )  # noqa: E501
        # verify the required parameter 'content_type' is set
        if "content_type" not in params or params["content_type"] is None:
            raise ValueError(
                "Missing the required parameter `content_type` when calling `v1_credit_cards_rewards_point_balance_search_post`"
            )  # noqa: E501
