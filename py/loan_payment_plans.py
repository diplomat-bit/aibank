...
class LoanPaymentPlans(object):
    ...
    def __init__(
        ...
        first_total_installment_amount=None,
        loan_cet_percentage=None,
        fixed_interest_rate=None,
        loan_booking_fee_indicator=None,
        loan_booking_fee=None,
        loan_booking_fee_percentage=None,
    ...
    def loan_tenure(self, loan_tenure):
        ...
        if loan_tenure is None:
            raise ValueError(
                "Invalid value for `loan_tenure`, must not be `None`"
            )  # noqa: E501
