...
class NotifyCreditChargeCardFulfillmentArrangementAuthorisedTransactionRequest(object):
    ...
    def __init__(
        ...
        reward_settlement_currency=None,
        billing_currency=None,
        reward_billing_currency=None,
        merchant_name=None,
        transaction_date=None,
        transaction_billing_amount=None,
        transaction_settlement_amount=None,
        remarks=None,
    ):  # noqa: E501
    ...
    def vop_transaction_id(self, vop_transaction_id):
        ...
        if vop_transaction_id is None:
            raise ValueError(
                "Invalid value for `vop_transaction_id`, must not be `None`"
            )  # noqa: E501
    ...
    def distributor_id(self, distributor_id):
        ...
        if distributor_id is None:
            raise ValueError(
                "Invalid value for `distributor_id`, must not be `None`"
            )  # noqa: E501
    ...
    def credit_status(self, credit_status):
        ...
        if credit_status is None:
            raise ValueError(
                "Invalid value for `credit_status`, must not be `None`"
            )  # noqa: E501
    ...
    def request_date_time(self, request_date_time):
        ...
        if request_date_time is None:
            raise ValueError(
                "Invalid value for `request_date_time`, must not be `None`"
            )  # noqa: E501
    ...
    def offer_id(self, offer_id):
        ...
        if offer_id is None:
            raise ValueError(
                "Invalid value for `offer_id`, must not be `None`"
            )  # noqa: E501
    ...
    def settlement_currency(self, settlement_currency):
        ...
        if settlement_currency is None:
            raise ValueError(
                "Invalid value for `settlement_currency`, must not be `None`"
            )  # noqa: E501
    ...
    def reward_settlement_currency(self, reward_settlement_currency):
        ...
        if reward_settlement_currency is None:
            raise ValueError(
                "Invalid value for `reward_settlement_currency`, must not be `None`"
            )  # noqa: E501
    ...
    def billing_currency(self, billing_currency):
        ...
        if billing_currency is None:
            raise ValueError(
                "Invalid value for `billing_currency`, must not be `None`"
            )  # noqa: E501
    ...
    def reward_billing_currency(self, reward_billing_currency):
        ...
        if reward_billing_currency is None:
            raise ValueError(
                "Invalid value for `reward_billing_currency`, must not be `None`"
            )  # noqa: E501
    ...
    def merchant_name(self, merchant_name):
        ...
        if merchant_name is None:
            raise ValueError(
                "Invalid value for `merchant_name`, must not be `None`"
            )  # noqa: E501
    ...
    def transaction_billing_amount(self, transaction_billing_amount):
        ...
        if transaction_billing_amount is None:
            raise ValueError(
                "Invalid value for `transaction_billing_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def transaction_settlement_amount(self, transaction_settlement_amount):
        ...
        if transaction_settlement_amount is None:
            raise ValueError(
                "Invalid value for `transaction_settlement_amount`, must not be `None`"
            )  # noqa: E501
