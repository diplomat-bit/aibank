...
class MarketingCampaignOffer(object):
    ...
    def campaign_id(self, campaign_id):
        ...
        if campaign_id is None:
            raise ValueError(
                "Invalid value for `campaign_id`, must not be `None`"
            )  # noqa: E501
    ...
    def wave_id(self, wave_id):
        ...
        if wave_id is None:
            raise ValueError(
                "Invalid value for `wave_id`, must not be `None`"
            )  # noqa: E501
    ...
    def channel_id(self, channel_id):
        ...
        if channel_id is None:
            raise ValueError(
                "Invalid value for `channel_id`, must not be `None`"
            )  # noqa: E501
    ...
    def offer_expiry_date(self, offer_expiry_date):
        ...
        if offer_expiry_date is None:
            raise ValueError(
                "Invalid value for `offer_expiry_date`, must not be `None`"
            )  # noqa: E501
    ...
    def offer_status(self, offer_status):
        ...
        if offer_status is None:
            raise ValueError(
                "Invalid value for `offer_status`, must not be `None`"
            )  # noqa: E501
