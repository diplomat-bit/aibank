...
class Interest(object):
    ...
    """
    swagger_types = {"product_group": "str", "campaign_id": "str", "wave_id": "str"}
    ...
    def __init__(
        self, product_group=None, campaign_id=None, wave_id=None
    ):  # noqa: E501
    ...
    def product_group(self, product_group):
        ...
        if product_group is None:
            raise ValueError(
                "Invalid value for `product_group`, must not be `None`"
            )  # noqa: E501
