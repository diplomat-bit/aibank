...
class PresetAtmPinAddRequest(object):
    ...
    def __init__(
        ...
        encrypted_pin=None,
        pin_registration_key=None,
        pin_length=None,
        key_device_id=None,
        key_generation_id=None,
    ):  # noqa: E501
    ...
    def application_id(self, application_id):
        ...
        if application_id is None:
            raise ValueError(
                "Invalid value for `application_id`, must not be `None`"
            )  # noqa: E501
    ...
    def control_flow_id(self, control_flow_id):
        ...
        if control_flow_id is None:
            raise ValueError(
                "Invalid value for `control_flow_id`, must not be `None`"
            )  # noqa: E501
    ...
    def encrypted_pin(self, encrypted_pin):
        ...
        if encrypted_pin is None:
            raise ValueError(
                "Invalid value for `encrypted_pin`, must not be `None`"
            )  # noqa: E501
    ...
    def pin_registration_key(self, pin_registration_key):
        ...
        if pin_registration_key is None:
            raise ValueError(
                "Invalid value for `pin_registration_key`, must not be `None`"
            )  # noqa: E501
    ...
    def pin_length(self, pin_length):
        ...
        if pin_length is None:
            raise ValueError(
                "Invalid value for `pin_length`, must not be `None`"
            )  # noqa: E501
    ...
    def key_device_id(self, key_device_id):
        ...
        if key_device_id is None:
            raise ValueError(
                "Invalid value for `key_device_id`, must not be `None`"
            )  # noqa: E501
    ...
    def key_generation_id(self, key_generation_id):
        ...
        if key_generation_id is None:
            raise ValueError(
                "Invalid value for `key_generation_id`, must not be `None`"
            )  # noqa: E501
