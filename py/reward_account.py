...
class RewardAccount(object):
    ...
    def __init__(
        ...
        reward_category_code=None,
        last_statement_point_balance=None,
        points_earned=None,
        reward_account_error_details=None,
    ):  # noqa: E501
    ...
    def display_card_number(self, display_card_number):
        ...
        if display_card_number is None:
            raise ValueError(
                "Invalid value for `display_card_number`, must not be `None`"
            )  # noqa: E501
    ...
    def available_point_balance(self, available_point_balance):
        ...
        if available_point_balance is None:
            raise ValueError(
                "Invalid value for `available_point_balance`, must not be `None`"
            )  # noqa: E501
