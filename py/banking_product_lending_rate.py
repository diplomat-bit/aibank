...
class BankingProductLendingRate(object):
    ...
    def lending_rate_type(self, lending_rate_type):
        ...
        if lending_rate_type is None:
            raise ValueError(
                "Invalid value for `lending_rate_type`, must not be `None`"
            )  # noqa: E501
        allowed_values = [
            "FIXED",
            "VARIABLE",
        ...
        if lending_rate_type not in allowed_values:
            raise ValueError(
                "Invalid value for `lending_rate_type` ({0}), must be one of {1}".format(  # noqa: E501
                    lending_rate_type, allowed_values
                )
            )
    ...
    def interest_payment_due(self, interest_payment_due):
        ...
        if interest_payment_due not in allowed_values:
            raise ValueError(
                "Invalid value for `interest_payment_due` ({0}), must be one of {1}".format(  # noqa: E501
                    interest_payment_due, allowed_values
                )
            )
