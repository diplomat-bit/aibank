...
class CreditLimitDecreaseResponse(object):
    ...
    def __init__(
        ...
        credit_limitd_decrease_reference_id=None,
        customer_consent_required_flag=None,
    ):  # noqa: E501
        ...
        if credit_limitd_decrease_reference_id is not None:
            self.credit_limitd_decrease_reference_id = (
                credit_limitd_decrease_reference_id
            )
