...
class AccountBalancesSummaryInquiryResponse(object):
    ...
    def __init__(
        self,
        credit_card_account_balance_summary=None,
        ready_credit_account_balance_summary=None,
    ):  # noqa: E501
        ...
        if credit_card_account_balance_summary is not None:
            self.credit_card_account_balance_summary = (
                credit_card_account_balance_summary
            )
        if ready_credit_account_balance_summary is not None:
            self.ready_credit_account_balance_summary = (
                ready_credit_account_balance_summary
            )
    ...
    def ready_credit_account_balance_summary(
        self, ready_credit_account_balance_summary
    ):
        ...
        self._ready_credit_account_balance_summary = (
            ready_credit_account_balance_summary
        )
