...
class BankingProductRateTierSubTier(object):
    ...
    def unit_of_measure(self, unit_of_measure):
        ...
        if unit_of_measure is None:
            raise ValueError(
                "Invalid value for `unit_of_measure`, must not be `None`"
            )  # noqa: E501
        allowed_values = ["DOLLAR", "PERCENT", "MONTH", "DAY"]  # noqa: E501
        if unit_of_measure not in allowed_values:
            raise ValueError(
                "Invalid value for `unit_of_measure` ({0}), must be one of {1}".format(  # noqa: E501
    ...
    def minimum_value(self, minimum_value):
        ...
        if minimum_value is None:
            raise ValueError(
                "Invalid value for `minimum_value`, must not be `None`"
            )  # noqa: E501
    ...
    def maximum_value(self, maximum_value):
        ...
        if maximum_value is None:
            raise ValueError(
                "Invalid value for `maximum_value`, must not be `None`"
            )  # noqa: E501
    ...
    def rate_application_method(self, rate_application_method):
        ...
        if rate_application_method not in allowed_values:
            raise ValueError(
                "Invalid value for `rate_application_method` ({0}), must be one of {1}".format(  # noqa: E501
                    rate_application_method, allowed_values
                )
            )
