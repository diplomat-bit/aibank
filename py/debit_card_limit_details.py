...
class DebitCardLimitDetails(object):
    ...
    def __init__(
        self,
        pos_spending_limit_amount=None,
        daily_atm_withdrawal_limit_amount=None,
        daily_internet_purchase_limit_amount=None,
    ):  # noqa: E501
        ...
        if daily_internet_purchase_limit_amount is not None:
            self.daily_internet_purchase_limit_amount = (
                daily_internet_purchase_limit_amount
            )
    ...
    def daily_internet_purchase_limit_amount(
        self, daily_internet_purchase_limit_amount
    ):
        ...
        self._daily_internet_purchase_limit_amount = (
            daily_internet_purchase_limit_amount
        )
