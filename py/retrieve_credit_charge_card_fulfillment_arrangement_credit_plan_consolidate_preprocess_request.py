...
class RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest(
    ...
    def __init__(
        ...
        loan_tenure_inmonths=None,
        top_up_amount=None,
        loan_description=None,
        disbursement_option=None,
        disbursement_account_id=None,
        payee_id=None,
        beneficiary_bank_detail=None,
        loan_purpose=None,
    ):  # noqa: E501
    ...
    def total_loan_amount(self, total_loan_amount):
        ...
        if total_loan_amount is None:
            raise ValueError(
                "Invalid value for `total_loan_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def loan_tenure_inmonths(self, loan_tenure_inmonths):
        ...
        if loan_tenure_inmonths is None:
            raise ValueError(
                "Invalid value for `loan_tenure_inmonths`, must not be `None`"
            )  # noqa: E501
    ...
    def top_up_amount(self, top_up_amount):
        ...
        if top_up_amount is None:
            raise ValueError(
                "Invalid value for `top_up_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def loan_description(self, loan_description):
        ...
        if loan_description is None:
            raise ValueError(
                "Invalid value for `loan_description`, must not be `None`"
            )  # noqa: E501
    ...
    def disbursement_option(self, disbursement_option):
        ...
        if disbursement_option is None:
            raise ValueError(
                "Invalid value for `disbursement_option`, must not be `None`"
            )  # noqa: E501
