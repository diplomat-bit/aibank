...
class DataProductDetails(object):
    ...
    def __init__(
        ...
        shariah_compliance=None,
        shariah_compliance_remark=None,
        card_type=None,
        pds_url=None,
        image_url=None,
        disclaimer_url=None,
    ...
    def product_type(self, product_type):
        ...
        if product_type is None:
            raise ValueError(
                "Invalid value for `product_type`, must not be `None`"
            )  # noqa: E501
        allowed_values = [
            "american_express",
            "jcb",
        ...
        if product_type not in allowed_values:
            raise ValueError(
                "Invalid value for `product_type` ({0}), must be one of {1}".format(  # noqa: E501
    ...
    def sub_product_type(self, sub_product_type):
        ...
        if sub_product_type not in allowed_values:
            raise ValueError(
                "Invalid value for `sub_product_type` ({0}), must be one of {1}".format(  # noqa: E501
                    sub_product_type, allowed_values
                )
            )
    ...
    def shariah_compliance(self, shariah_compliance):
        ...
        if shariah_compliance is None:
            raise ValueError(
                "Invalid value for `shariah_compliance`, must not be `None`"
            )  # noqa: E501
    ...
    def card_type(self, card_type):
        ...
        if card_type is None:
            raise ValueError(
                "Invalid value for `card_type`, must not be `None`"
            )  # noqa: E501
        allowed_values = [
            "credit_card",
            "debit_card",
    ...
    def pds_url(self, pds_url):
        ...
        if pds_url is None:
            raise ValueError(
                "Invalid value for `pds_url`, must not be `None`"
            )  # noqa: E501
