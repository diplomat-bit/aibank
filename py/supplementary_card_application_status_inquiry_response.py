...
class SupplementaryCardApplicationStatusInquiryResponse(object):
    ...
    """
    swagger_types = {"application_status": "str", "application_creation_date": "date"}
    ...
    def __init__(
        self, application_status=None, application_creation_date=None
    ):  # noqa: E501
    ...
    def application_status(self, application_status):
        ...
        if application_status is None:
            raise ValueError(
                "Invalid value for `application_status`, must not be `None`"
            )  # noqa: E501
    ...
    def application_creation_date(self, application_creation_date):
        ...
        if application_creation_date is None:
            raise ValueError(
                "Invalid value for `application_creation_date`, must not be `None`"
            )  # noqa: E501
