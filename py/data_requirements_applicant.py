...
class DataRequirementsApplicant(object):
    ...
    def __init__(
        ...
        min_annual_income_currency_code="MYR",
        document=None,
    ):  # noqa: E501
    ...
    def application_type(self, application_type):
        ...
        if application_type is None:
            raise ValueError(
                "Invalid value for `application_type`, must not be `None`"
            )  # noqa: E501
        allowed_values = ["principal", "supplementary", "any"]  # noqa: E501
        if application_type not in allowed_values:
            raise ValueError(
                "Invalid value for `application_type` ({0}), must be one of {1}".format(  # noqa: E501
                    application_type, allowed_values
                )
            )
    ...
    def employment_status(self, employment_status):
        ...
        if employment_status not in allowed_values:
            raise ValueError(
                "Invalid value for `employment_status` ({0}), must be one of {1}".format(  # noqa: E501
                    employment_status, allowed_values
                )
            )
