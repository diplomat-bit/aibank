...
class InsurancePolicySummary(object):
    ...
    def __init__(
        ...
        account_status=None,
        display_policy_number=None,
        insurance_application_id=None,
        insurance_sum_assured_amount=None,
        total_premium_paid_amount=None,
    ):  # noqa: E501
    ...
    def display_policy_number(self, display_policy_number):
        ...
        if display_policy_number is None:
            raise ValueError(
                "Invalid value for `display_policy_number`, must not be `None`"
            )  # noqa: E501
    ...
    def insurance_application_id(self, insurance_application_id):
        ...
        if insurance_application_id is None:
            raise ValueError(
                "Invalid value for `insurance_application_id`, must not be `None`"
            )  # noqa: E501
