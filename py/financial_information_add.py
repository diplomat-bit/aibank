...
class FinancialInformationAdd(object):
    ...
    def __init__(
        self,
        has_foreseeable_financial_changes=None,
        non_bank_debt_obligation_flag=None,
        expense_details=None,
        income_details=None,
        existing_loan_details=None,
        external_credit_card_details=None,
        self_employed_business_asset_value=None,
    ):  # noqa: E501
