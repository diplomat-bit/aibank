...
class CreditCardAccountBalanceSummary(object):
    ...
    def __init__(
        self,
        total_disputed_transaction_amount=None,
        current_outstanding_amount=None,
        current_accrued_interest=None,
        payment_due_amount=None,
        available_point_balance=None,
        partial_response_information=None,
    ):  # noqa: E501
    ...
    def current_outstanding_amount(self, current_outstanding_amount):
        ...
        if current_outstanding_amount is None:
            raise ValueError(
                "Invalid value for `current_outstanding_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def current_accrued_interest(self, current_accrued_interest):
        ...
        if current_accrued_interest is None:
            raise ValueError(
                "Invalid value for `current_accrued_interest`, must not be `None`"
            )  # noqa: E501
    ...
    def payment_due_amount(self, payment_due_amount):
        ...
        if payment_due_amount is None:
            raise ValueError(
                "Invalid value for `payment_due_amount`, must not be `None`"
            )  # noqa: E501
