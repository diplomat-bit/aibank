...
class UpdateCreditChargeCardCorporateCardsCreditLimitRequest(object):
    ...
    def credit_limit_amount(self, credit_limit_amount):
        ...
        if credit_limit_amount is None:
            raise ValueError(
                "Invalid value for `credit_limit_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def credit_limit_indicator(self, credit_limit_indicator):
        ...
        if credit_limit_indicator is None:
            raise ValueError(
                "Invalid value for `credit_limit_indicator`, must not be `None`"
            )  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(
            other, UpdateCreditChargeCardCorporateCardsCreditLimitRequest
        ):
            return False
