...
class ApplicationUpdateBalanceTransferDetails(object):
    ...
    def __init__(
        ...
        issuing_organization_name=None,
        account_name=None,
        account_reference_number=None,
        biller_code=None,
        campaign_id=None,
    ):  # noqa: E501
    ...
    def amount_to_transfer(self, amount_to_transfer):
        ...
        if amount_to_transfer is None:
            raise ValueError(
                "Invalid value for `amount_to_transfer`, must not be `None`"
            )  # noqa: E501
    ...
    def biller_code(self, biller_code):
        ...
        if biller_code is None:
            raise ValueError(
                "Invalid value for `biller_code`, must not be `None`"
            )  # noqa: E501
