...
class DataProductOfferings(object):
    ...
    def __init__(
        self, category=None, item=None, remark=None, branding=None, tnc_url=None
    ):  # noqa: E501
    ...
    def item(self, item):
        ...
        if item is None:
            raise ValueError(
                "Invalid value for `item`, must not be `None`"
            )  # noqa: E501
        allowed_values = [
            "bookstore",
        ...
        if item not in allowed_values:
            raise ValueError(
                "Invalid value for `item` ({0}), must be one of {1}".format(  # noqa: E501
                    item, allowed_values
                )
            )
