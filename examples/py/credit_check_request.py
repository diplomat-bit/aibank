...
class CreditCheckRequest(object):
    ...
    def __init__(
        self,
        monthly_income=None,
        total_monthly_secured_loan_repayment_amount=None,
        total_monthly_unsecured_loan_repayment_amount=None,
    ):  # noqa: E501
        ...
        if total_monthly_secured_loan_repayment_amount is not None:
            self.total_monthly_secured_loan_repayment_amount = (
                total_monthly_secured_loan_repayment_amount
            )
        if total_monthly_unsecured_loan_repayment_amount is not None:
            self.total_monthly_unsecured_loan_repayment_amount = (
                total_monthly_unsecured_loan_repayment_amount
            )
    ...
    def monthly_income(self, monthly_income):
        ...
        if monthly_income is None:
            raise ValueError(
                "Invalid value for `monthly_income`, must not be `None`"
            )  # noqa: E501
    ...
    def total_monthly_secured_loan_repayment_amount(
        self, total_monthly_secured_loan_repayment_amount
    ):
        ...
        self._total_monthly_secured_loan_repayment_amount = (
            total_monthly_secured_loan_repayment_amount
        )
    ...
    def total_monthly_unsecured_loan_repayment_amount(
        self, total_monthly_unsecured_loan_repayment_amount
    ):
        ...
        self._total_monthly_unsecured_loan_repayment_amount = (
            total_monthly_unsecured_loan_repayment_amount
        )
