...
class StatementSummary(object):
    ...
    def __init__(
        ...
        credit_limit=None,
        active_equal_payment_plan_count=None,
        beginning_balance_amount=None,
        ...
        cycle_to_date_fee_amount=None,
        interest_paid_amount=None,
        billing_currency_code=None,
        cash_advance_available_amount=None,
        retail_cycle_interest_rate=None,
        cash_cycle_interest_rate=None,
        private_label_credit_cards=None,
    ):  # noqa: E501
