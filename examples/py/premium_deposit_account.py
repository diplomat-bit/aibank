...
class PremiumDepositAccount(object):
    ...
    def __init__(
        ...
        base_currency_principal_amount=None,
        base_currency_code=None,
        alternate_currency_principal_amount=None,
        opening_date=None,
        alternate_currency_code=None,
        base_currency_disposal_account=None,
        alternate_currency_disposal_account=None,
        base_currency_interest_amount=None,
        alternate_currency_interest_amount=None,
        base_currency_maturity_amount=None,
        alternate_currency_maturity_amount=None,
        base_currency_premium_amount=None,
        maturity_date=None,
        strike_price=None,
        customer_interest_rate=None,
        ...
        if alternate_currency_principal_amount is not None:
            self.alternate_currency_principal_amount = (
                alternate_currency_principal_amount
            )
        ...
        if alternate_currency_disposal_account is not None:
            self.alternate_currency_disposal_account = (
                alternate_currency_disposal_account
            )
    ...
    def display_account_number(self, display_account_number):
        ...
        if display_account_number is None:
            raise ValueError(
                "Invalid value for `display_account_number`, must not be `None`"
            )  # noqa: E501
