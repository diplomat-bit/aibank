...
class Loans(object):
    ...
    def __init__(
        self,
        loan_reference_id=None,
        display_account_number=None,
        transaction_date=None,
        transaction_description=None,
        installment_amount=None,
        next_installment_amount=None,
        outstanding_balance_amount=None,
        tenor=None,
        outstanding_tenor=None,
        original_loan_amount=None,
        annual_percentage_rate=None,
        effective_interest_rate=None,
        processing_charge_amount=None,
        outstanding_interest_amount=None,
        self_early_loan_closure_allowed_flag=None,
        installment_cycle=None,
    ):  # noqa: E501
        ...
        if self_early_loan_closure_allowed_flag is not None:
            self.self_early_loan_closure_allowed_flag = (
                self_early_loan_closure_allowed_flag
            )
    ...
    def loan_reference_id(self, loan_reference_id):
        ...
        if loan_reference_id is None:
            raise ValueError(
                "Invalid value for `loan_reference_id`, must not be `None`"
            )  # noqa: E501
    ...
    def transaction_description(self, transaction_description):
        ...
        if transaction_description is None:
            raise ValueError(
                "Invalid value for `transaction_description`, must not be `None`"
            )  # noqa: E501
    ...
    def installment_amount(self, installment_amount):
        ...
        if installment_amount is None:
            raise ValueError(
                "Invalid value for `installment_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def outstanding_balance_amount(self, outstanding_balance_amount):
        ...
        if outstanding_balance_amount is None:
            raise ValueError(
                "Invalid value for `outstanding_balance_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def tenor(self, tenor):
        ...
        if tenor is None:
            raise ValueError(
                "Invalid value for `tenor`, must not be `None`"
            )  # noqa: E501
    ...
    def original_loan_amount(self, original_loan_amount):
        ...
        if original_loan_amount is None:
            raise ValueError(
                "Invalid value for `original_loan_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def annual_percentage_rate(self, annual_percentage_rate):
        ...
        if annual_percentage_rate is None:
            raise ValueError(
                "Invalid value for `annual_percentage_rate`, must not be `None`"
            )  # noqa: E501
    ...
    def self_early_loan_closure_allowed_flag(
        self, self_early_loan_closure_allowed_flag
    ):
        ...
        self._self_early_loan_closure_allowed_flag = (
            self_early_loan_closure_allowed_flag
        )
