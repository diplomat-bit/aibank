...
class ProductsApi(object):
    ...
    def get_product_detail(self, product_id, x_v, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_product_detail_with_http_info(
                product_id, x_v, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_product_detail_with_http_info(
                product_id, x_v, **kwargs
            )  # noqa: E501
            return data

    def get_product_detail_with_http_info(
        self, product_id, x_v, **kwargs
    ):  # noqa: E501
        """Get Product Detail  # noqa: E501
        ...
        if "product_id" not in params or params["product_id"] is None:
            raise ValueError(
                "Missing the required parameter `product_id` when calling `get_product_detail`"
            )  # noqa: E501
        # verify the required parameter 'x_v' is set
        if "x_v" not in params or params["x_v"] is None:
            raise ValueError(
                "Missing the required parameter `x_v` when calling `get_product_detail`"
            )  # noqa: E501
    ...
    def list_products_with_http_info(self, x_v, **kwargs):  # noqa: E501
        ...
        if "x_v" not in params or params["x_v"] is None:
            raise ValueError(
                "Missing the required parameter `x_v` when calling `list_products`"
            )  # noqa: E501
        ...
        if "updated_since" in params:
            query_params.append(
                ("updated-since", params["updated_since"])
            )  # noqa: E501
        if "brand" in params:
