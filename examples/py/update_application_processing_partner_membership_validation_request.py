...
class UpdateApplicationProcessingPartnerMembershipValidationRequest(object):
    ...
    def __init__(
        self,
        membership_information=None,
        sales_agent_details=None,
        product=None,
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(
            UpdateApplicationProcessingPartnerMembershipValidationRequest, dict
        ):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(
            other, UpdateApplicationProcessingPartnerMembershipValidationRequest
        ):
            return False
