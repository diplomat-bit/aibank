...
class DataRequirementsRequirementDetail(object):
    ...
    def __init__(
        self,
        nationality=None,
        nationality_remark=None,
        residency=None,
        account_holder_flag=None,
        applicant=None,
    ):  # noqa: E501
    ...
    def nationality(self, nationality):
        ...
        if nationality is None:
            raise ValueError(
                "Invalid value for `nationality`, must not be `None`"
            )  # noqa: E501
        allowed_values = ["malaysian", "non_malaysian", "any"]  # noqa: E501
        if nationality not in allowed_values:
            raise ValueError(
                "Invalid value for `nationality` ({0}), must be one of {1}".format(  # noqa: E501
                    nationality, allowed_values
                )
            )
    ...
    def residency(self, residency):
        ...
        if residency is None:
            raise ValueError(
                "Invalid value for `residency`, must not be `None`"
            )  # noqa: E501
        allowed_values = ["resident", "non_resident", "any"]  # noqa: E501
        if residency not in allowed_values:
            raise ValueError(
                "Invalid value for `residency` ({0}), must be one of {1}".format(  # noqa: E501
                    residency, allowed_values
                )
            )
