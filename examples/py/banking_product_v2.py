...
class BankingProductV2(object):
    ...
    def last_updated(self, last_updated):
        ...
        if last_updated is None:
            raise ValueError(
                "Invalid value for `last_updated`, must not be `None`"
            )  # noqa: E501
    ...
    def product_category(self, product_category):
        ...
        if product_category is None:
            raise ValueError(
                "Invalid value for `product_category`, must not be `None`"
            )  # noqa: E501
    ...
    def brand(self, brand):
        ...
        if brand is None:
            raise ValueError(
                "Invalid value for `brand`, must not be `None`"
            )  # noqa: E501
    ...
    def is_tailored(self, is_tailored):
        ...
        if is_tailored is None:
            raise ValueError(
                "Invalid value for `is_tailored`, must not be `None`"
            )  # noqa: E501
