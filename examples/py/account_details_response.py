...
class AccountDetailsResponse(object):
    ...
    def __init__(
        ...
        ready_credit_account=None,
        checking_account=None,
        savings_account=None,
        time_deposit_account=None,
        loan_account=None,
        mutual_fund_account=None,
        securities_brokerage_account=None,
        call_deposit_account=None,
        premium_deposit_account=None,
    ):  # noqa: E501
