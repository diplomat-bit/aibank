...
class Statement(object):
    ...
    def __init__(
        self,
        epp_maximum_eligible_amount=None,
        epp_minimum_eligible_amount=None,
        statement_balance_amount=None,
    ):  # noqa: E501
    ...
    def epp_maximum_eligible_amount(self, epp_maximum_eligible_amount):
        ...
        if epp_maximum_eligible_amount is None:
            raise ValueError(
                "Invalid value for `epp_maximum_eligible_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def epp_minimum_eligible_amount(self, epp_minimum_eligible_amount):
        ...
        if epp_minimum_eligible_amount is None:
            raise ValueError(
                "Invalid value for `epp_minimum_eligible_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def statement_balance_amount(self, statement_balance_amount):
        ...
        if statement_balance_amount is None:
            raise ValueError(
                "Invalid value for `statement_balance_amount`, must not be `None`"
            )  # noqa: E501
