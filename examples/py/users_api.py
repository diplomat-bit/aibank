...
class UsersApi(object):
    ...
    def supplementary_card_application_status_inquiry(
        self,
        authorization,
        uuid,
        accept,
        ...
        **kwargs,
        ...
        if kwargs.get("async_req"):
            return self.supplementary_card_application_status_inquiry_with_http_info(
                authorization,
                uuid,
                accept,
                client_id,
            ...
            (data) = self.supplementary_card_application_status_inquiry_with_http_info(
                authorization,
                uuid,
                accept,
                client_id,
    ...
    def supplementary_card_application_status_inquiry_with_http_info(
        self,
        authorization,
        uuid,
        accept,
        ...
        **kwargs,
        ...
        if "authorization" not in params or params["authorization"] is None:
            raise ValueError(
                "Missing the required parameter `authorization` when calling `supplementary_card_application_status_inquiry`"
            )  # noqa: E501
        # verify the required parameter 'uuid' is set
        if "uuid" not in params or params["uuid"] is None:
            raise ValueError(
                "Missing the required parameter `uuid` when calling `supplementary_card_application_status_inquiry`"
            )  # noqa: E501
        # verify the required parameter 'accept' is set
        if "accept" not in params or params["accept"] is None:
            raise ValueError(
                "Missing the required parameter `accept` when calling `supplementary_card_application_status_inquiry`"
            )  # noqa: E501
        # verify the required parameter 'client_id' is set
        if "client_id" not in params or params["client_id"] is None:
            raise ValueError(
                "Missing the required parameter `client_id` when calling `supplementary_card_application_status_inquiry`"
            )  # noqa: E501
        # verify the required parameter 'application_id' is set
        if "application_id" not in params or params["application_id"] is None:
            raise ValueError(
                "Missing the required parameter `application_id` when calling `supplementary_card_application_status_inquiry`"
            )  # noqa: E501
        # verify the required parameter 'date_of_birth' is set
        if "date_of_birth" not in params or params["date_of_birth"] is None:
            raise ValueError(
                "Missing the required parameter `date_of_birth` when calling `supplementary_card_application_status_inquiry`"
            )  # noqa: E501
        # verify the required parameter 'mother_maiden_name' is set
        if "mother_maiden_name" not in params or params["mother_maiden_name"] is None:
            raise ValueError(
                "Missing the required parameter `mother_maiden_name` when calling `supplementary_card_application_status_inquiry`"
            )  # noqa: E501
        ...
        if "mother_maiden_name" in params:
            query_params.append(
                ("motherMaidenName", params["mother_maiden_name"])
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            "/v1/onboarding/supplementary/applications/{applicationId}/status",
            "GET",
            path_params,
            query_params,
            header_params,
