...
class EppLoanBookingRequest(object):
    ...
    def __init__(
        self, epp_loan_booking_type=None, tenor=None, epp_loan_booking=None
    ):  # noqa: E501
    ...
    def epp_loan_booking_type(self, epp_loan_booking_type):
        ...
        if epp_loan_booking_type is None:
            raise ValueError(
                "Invalid value for `epp_loan_booking_type`, must not be `None`"
            )  # noqa: E501
    ...
    def epp_loan_booking(self, epp_loan_booking):
        ...
        if epp_loan_booking is None:
            raise ValueError(
                "Invalid value for `epp_loan_booking`, must not be `None`"
            )  # noqa: E501
