...
class TemporaryCreditLimitIncrease(object):
    ...
    def __init__(
        self,
        card_id=None,
        credit_limit_increase_end_date=None,
        reason_code=None,
        credit_limit_increase_start_date=None,
        requested_credit_limit_amount=None,
    ):  # noqa: E501
    ...
    def credit_limit_increase_end_date(self, credit_limit_increase_end_date):
        ...
        if credit_limit_increase_end_date is None:
            raise ValueError(
                "Invalid value for `credit_limit_increase_end_date`, must not be `None`"
            )  # noqa: E501
    ...
    def reason_code(self, reason_code):
        ...
        if reason_code is None:
            raise ValueError(
                "Invalid value for `reason_code`, must not be `None`"
            )  # noqa: E501
    ...
    def credit_limit_increase_start_date(self, credit_limit_increase_start_date):
        ...
        if credit_limit_increase_start_date is None:
            raise ValueError(
                "Invalid value for `credit_limit_increase_start_date`, must not be `None`"
            )  # noqa: E501
    ...
    def requested_credit_limit_amount(self, requested_credit_limit_amount):
        ...
        if requested_credit_limit_amount is None:
            raise ValueError(
                "Invalid value for `requested_credit_limit_amount`, must not be `None`"
            )  # noqa: E501
