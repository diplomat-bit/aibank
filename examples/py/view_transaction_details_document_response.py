...
class ViewTransactionDetailsDocumentResponse(object):
    ...
    """
    swagger_types = {"binary_data": "str", "next_start_index": "str"}

    attribute_map = {"binary_data": "binaryData", "next_start_index": "nextStartIndex"}
    ...
    def binary_data(self, binary_data):
        ...
        if binary_data is None:
            raise ValueError(
                "Invalid value for `binary_data`, must not be `None`"
            )  # noqa: E501
