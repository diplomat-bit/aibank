...
class HistoryAndIntradayTransactions(object):
    ...
    def __init__(
        ...
        history_and_intraday_transaction_records=None,
    ):  # noqa: E501
        ...
        if history_and_intraday_transaction_records is not None:
            self.history_and_intraday_transaction_records = (
                history_and_intraday_transaction_records
            )
    ...
    def history_and_intraday_transaction_records(
        self, history_and_intraday_transaction_records
    ):
        ...
        self._history_and_intraday_transaction_records = (
            history_and_intraday_transaction_records
        )
