...
class EvaluateCustomerEligibilityAssessmentCheckPreLoginResponse(object):
    ...
    def __init__(
        ...
        account_group=None,
        maximum_eligible_loan_amount=None,
        minimum_eligible_loan_amount=None,
        offer_indicator=None,
        loan_booking_plan=None,
        lop_category=None,
    ):  # noqa: E501
    ...
    def maximum_eligible_loan_amount(self, maximum_eligible_loan_amount):
        ...
        if maximum_eligible_loan_amount is None:
            raise ValueError(
                "Invalid value for `maximum_eligible_loan_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def minimum_eligible_loan_amount(self, minimum_eligible_loan_amount):
        ...
        if minimum_eligible_loan_amount is None:
            raise ValueError(
                "Invalid value for `minimum_eligible_loan_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def offer_indicator(self, offer_indicator):
        ...
        if offer_indicator is None:
            raise ValueError(
                "Invalid value for `offer_indicator`, must not be `None`"
            )  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(
            other, EvaluateCustomerEligibilityAssessmentCheckPreLoginResponse
        ):
            return False
