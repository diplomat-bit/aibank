...
class CustomerApi(object):
    ...
    def sufficiency_of_funds(
        self,
        authorization,
        uuid,
        accept,
        client_id,
        sufficiency_check_amount,
        account_id,
        currency_code,
        **kwargs,
    ):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.sufficiency_of_funds_with_http_info(
                authorization,
                uuid,
                accept,
                client_id,
            ...
            (data) = self.sufficiency_of_funds_with_http_info(
                authorization,
                uuid,
                accept,
                client_id,
    ...
    def sufficiency_of_funds_with_http_info(
        self,
        authorization,
        uuid,
        accept,
        ...
        **kwargs,
        ...
        if "authorization" not in params or params["authorization"] is None:
            raise ValueError(
                "Missing the required parameter `authorization` when calling `sufficiency_of_funds`"
            )  # noqa: E501
        # verify the required parameter 'uuid' is set
        if "uuid" not in params or params["uuid"] is None:
            raise ValueError(
                "Missing the required parameter `uuid` when calling `sufficiency_of_funds`"
            )  # noqa: E501
        # verify the required parameter 'accept' is set
        if "accept" not in params or params["accept"] is None:
            raise ValueError(
                "Missing the required parameter `accept` when calling `sufficiency_of_funds`"
            )  # noqa: E501
        # verify the required parameter 'client_id' is set
        if "client_id" not in params or params["client_id"] is None:
            raise ValueError(
                "Missing the required parameter `client_id` when calling `sufficiency_of_funds`"
            )  # noqa: E501
        # verify the required parameter 'sufficiency_check_amount' is set
        if (
            "sufficiency_check_amount" not in params
            or params["sufficiency_check_amount"] is None
        ):
            raise ValueError(
                "Missing the required parameter `sufficiency_check_amount` when calling `sufficiency_of_funds`"
            )  # noqa: E501
        # verify the required parameter 'account_id' is set
        if "account_id" not in params or params["account_id"] is None:
            raise ValueError(
                "Missing the required parameter `account_id` when calling `sufficiency_of_funds`"
            )  # noqa: E501
        # verify the required parameter 'currency_code' is set
        if "currency_code" not in params or params["currency_code"] is None:
            raise ValueError(
                "Missing the required parameter `currency_code` when calling `sufficiency_of_funds`"
            )  # noqa: E501
        ...
        if "sufficiency_check_amount" in params:
            query_params.append(
                ("sufficiencyCheckAmount", params["sufficiency_check_amount"])
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            "/v1/accounts/{accountId}/funds/sufficiencyCheck",
            "GET",
            path_params,
            query_params,
            header_params,
