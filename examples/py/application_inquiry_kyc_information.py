...
class ApplicationInquiryKycInformation(object):
    ...
    def __init__(
        self,
        self_public_figure_declaration_flag=None,
        public_figure_office_status=None,
        public_figure_office_details=None,
        public_figure_office_start_date=None,
        public_figure_office_end_date=None,
        is_related_to_senior_public_figure=None,
        related_senior_public_figure_name=None,
        related_senior_public_figure_designation=None,
        related_spf_country_of_government=None,
        related_senior_public_figure_department=None,
        relationship_with_senior_public_figure=None,
        related_senior_public_figure_last_name=None,
        us_tax_status=None,
        us_tax_id=None,
    ):  # noqa: E501
        ...
        if self_public_figure_declaration_flag is not None:
            self.self_public_figure_declaration_flag = (
        ...
        if related_senior_public_figure_designation is not None:
            self.related_senior_public_figure_designation = (
                related_senior_public_figure_designation
            )
        ...
        if related_senior_public_figure_department is not None:
            self.related_senior_public_figure_department = (
                related_senior_public_figure_department
            )
        if relationship_with_senior_public_figure is not None:
            self.relationship_with_senior_public_figure = (
                relationship_with_senior_public_figure
            )
        if related_senior_public_figure_last_name is not None:
            self.related_senior_public_figure_last_name = (
                related_senior_public_figure_last_name
            )
    ...
    def related_senior_public_figure_designation(
        self, related_senior_public_figure_designation
    ):
        ...
        self._related_senior_public_figure_designation = (
            related_senior_public_figure_designation
        )
    ...
    def related_senior_public_figure_department(
        self, related_senior_public_figure_department
    ):
        ...
        self._related_senior_public_figure_department = (
            related_senior_public_figure_department
        )
    ...
    def relationship_with_senior_public_figure(
        self, relationship_with_senior_public_figure
    ):
        ...
        self._relationship_with_senior_public_figure = (
            relationship_with_senior_public_figure
        )
    ...
    def related_senior_public_figure_last_name(
        self, related_senior_public_figure_last_name
    ):
        ...
        self._related_senior_public_figure_last_name = (
            related_senior_public_figure_last_name
        )
