...
class ExistingCustomerCreditProductApplicationAddResponse(object):
    ...
    def __init__(
        ...
        survivor_line_required_flag=None,
        existing_credit_limit=None,
        display_applicant_details=None,
    ...
    def application_stage(self, application_stage):
        ...
        if application_stage is None:
            raise ValueError(
                "Invalid value for `application_stage`, must not be `None`"
            )  # noqa: E501
    ...
    def display_applicant_details(self, display_applicant_details):
        ...
        if display_applicant_details is None:
            raise ValueError(
                "Invalid value for `display_applicant_details`, must not be `None`"
            )  # noqa: E501
