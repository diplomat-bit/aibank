...
class InitiateApplicationProcessingUnsecuredLoanTopupRequest(object):
    ...
    def __init__(
        self,
        marketing_campaign_offer=None,
        account_id=None,
        card_id=None,
        product=None,
        requested_loan_amount=None,
        loan_topup_application_type=None,
    ...
    def loan_topup_application_type(self, loan_topup_application_type):
        ...
        if loan_topup_application_type is None:
            raise ValueError(
                "Invalid value for `loan_topup_application_type`, must not be `None`"
            )  # noqa: E501
    ...
    def spoken_language_code(self, spoken_language_code):
        ...
        if spoken_language_code is None:
            raise ValueError(
                "Invalid value for `spoken_language_code`, must not be `None`"
            )  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(
            other, InitiateApplicationProcessingUnsecuredLoanTopupRequest
        ):
            return False
