...
class ReadyCreditProduct(object):
    ...
    def __init__(
        ...
        organization=None,
        logo=None,
        request_credit_shield=None,
        emboss_name=None,
        billing_address=None,
        card_delivery_address=None,
        pin_delivery_address=None,
        gift_code=None,
        credit_limit_increase_indicator=None,
        atm_required_flag=None,
        cheque_book_required_flag=None,
        balance_transfer_details=None,
        loan_purpose=None,
        requested_credit_limit=None,
        equal_payment_plan=None,
        atm_pin_registration_flag=None,
        credit_limit_accepted_flag=None,
    ):  # noqa: E501
    ...
    def product_code(self, product_code):
        ...
        if product_code is None:
            raise ValueError(
                "Invalid value for `product_code`, must not be `None`"
            )  # noqa: E501
    ...
    def source_code(self, source_code):
        ...
        if source_code is None:
            raise ValueError(
                "Invalid value for `source_code`, must not be `None`"
            )  # noqa: E501
    ...
    def logo(self, logo):
        ...
        if logo is None:
            raise ValueError(
                "Invalid value for `logo`, must not be `None`"
            )  # noqa: E501
