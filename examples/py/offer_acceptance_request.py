...
class OfferAcceptanceRequest(object):
    ...
    def __init__(
        self,
        counter_product_accepted_flag=None,
        counter_product_confirmation=None,
        requested_product_confirmation=None,
    ...
    def requested_product_confirmation(self, requested_product_confirmation):
        ...
        if requested_product_confirmation is None:
            raise ValueError(
                "Invalid value for `requested_product_confirmation`, must not be `None`"
            )  # noqa: E501
