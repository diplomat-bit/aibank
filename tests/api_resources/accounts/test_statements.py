...
class TestStatements:
    ...
    def test_method_download_pdf(self, client: Jocall3, respx_mock: MockRouter) -> None:
        respx_mock.get("/accounts/accountId/statements/statementId/pdf").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        statement = client.accounts.statements.download_pdf(
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_download_pdf(self, client: Jocall3, respx_mock: MockRouter) -> None:
        respx_mock.get("/accounts/accountId/statements/statementId/pdf").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )

        statement = client.accounts.statements.with_raw_response.download_pdf(
            statement_id="statementId",
            account_id="accountId",
        )
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_streaming_response_download_pdf(self, client: Jocall3, respx_mock: MockRouter) -> None:
        respx_mock.get("/accounts/accountId/statements/statementId/pdf").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        with client.accounts.statements.with_streaming_response.download_pdf(
            statement_id="statementId",
            account_id="accountId",
        ) as statement:
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_path_params_download_pdf(self, client: Jocall3) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.accounts.statements.with_raw_response.download_pdf(
                statement_id="statementId",
                account_id="",
            )
...
class TestAsyncStatements:
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_method_download_pdf(self, async_client: AsyncJocall3, respx_mock: MockRouter) -> None:
        respx_mock.get("/accounts/accountId/statements/statementId/pdf").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        statement = await async_client.accounts.statements.download_pdf(
            statement_id="statementId",
            account_id="accountId",
        )
        assert statement.is_closed
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_download_pdf(self, async_client: AsyncJocall3, respx_mock: MockRouter) -> None:
        respx_mock.get("/accounts/accountId/statements/statementId/pdf").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )

        statement = await async_client.accounts.statements.with_raw_response.download_pdf(
            statement_id="statementId",
            account_id="accountId",
        )
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_streaming_response_download_pdf(self, async_client: AsyncJocall3, respx_mock: MockRouter) -> None:
        respx_mock.get("/accounts/accountId/statements/statementId/pdf").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        async with async_client.accounts.statements.with_streaming_response.download_pdf(
            statement_id="statementId",
            account_id="accountId",
        ) as statement:
            assert not statement.is_closed
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_path_params_download_pdf(self, async_client: AsyncJocall3) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.accounts.statements.with_raw_response.download_pdf(
                statement_id="statementId",
                account_id="",
            )
