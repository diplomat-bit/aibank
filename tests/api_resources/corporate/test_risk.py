...
from jocall3.types.corporate import RiskRunStressTestResponse, RiskRetrieveExposureResponse
...
class TestRisk:
    ...
    @parametrize
    def test_method_retrieve_exposure(self, client: Jocall3) -> None:
        risk = client.corporate.risk.retrieve_exposure()
        assert_matches_type(RiskRetrieveExposureResponse, risk, path=["response"])

    @parametrize
    def test_raw_response_retrieve_exposure(self, client: Jocall3) -> None:
        response = client.corporate.risk.with_raw_response.retrieve_exposure()
    ...
    @parametrize
    def test_streaming_response_retrieve_exposure(self, client: Jocall3) -> None:
        with client.corporate.risk.with_streaming_response.retrieve_exposure() as response:
...
class TestAsyncRisk:
    ...
    @parametrize
    async def test_method_retrieve_exposure(self, async_client: AsyncJocall3) -> None:
        risk = await async_client.corporate.risk.retrieve_exposure()
        assert_matches_type(RiskRetrieveExposureResponse, risk, path=["response"])

    @parametrize
    async def test_raw_response_retrieve_exposure(self, async_client: AsyncJocall3) -> None:
        response = await async_client.corporate.risk.with_raw_response.retrieve_exposure()
    ...
    @parametrize
    async def test_streaming_response_retrieve_exposure(self, async_client: AsyncJocall3) -> None:
        async with async_client.corporate.risk.with_streaming_response.retrieve_exposure() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
