...
class TestNotifications:
    ...
    def test_method_send(self, client: Jocall3) -> None:
        notification = client.system.notifications.send(
            body="body",
            title="title",
            user_id="user_id",
        )
    ...
    def test_raw_response_send(self, client: Jocall3) -> None:
        response = client.system.notifications.with_raw_response.send(
            body="body",
            title="title",
            user_id="user_id",
        )
    ...
    def test_streaming_response_send(self, client: Jocall3) -> None:
        with client.system.notifications.with_streaming_response.send(
            body="body",
            title="title",
            user_id="user_id",
        ) as response:
...
class TestAsyncNotifications:
    ...
    async def test_method_send(self, async_client: AsyncJocall3) -> None:
        notification = await async_client.system.notifications.send(
            body="body",
            title="title",
            user_id="user_id",
        )
    ...
    async def test_raw_response_send(self, async_client: AsyncJocall3) -> None:
        response = await async_client.system.notifications.with_raw_response.send(
            body="body",
            title="title",
            user_id="user_id",
        )
    ...
    async def test_streaming_response_send(self, async_client: AsyncJocall3) -> None:
        async with async_client.system.notifications.with_streaming_response.send(
            body="body",
            title="title",
            user_id="user_id",
        ) as response:
