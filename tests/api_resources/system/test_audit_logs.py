...
class TestAuditLogs:
    ...
    def test_method_list(self, client: Jocall3) -> None:
        audit_log = client.system.audit_logs.list()
    ...
    def test_raw_response_list(self, client: Jocall3) -> None:
        response = client.system.audit_logs.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Jocall3) -> None:
        with client.system.audit_logs.with_streaming_response.list() as response:
...
class TestAsyncAuditLogs:
    ...
    async def test_method_list(self, async_client: AsyncJocall3) -> None:
        audit_log = await async_client.system.audit_logs.list()
        assert_matches_type(AuditLogListResponse, audit_log, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncJocall3) -> None:
        response = await async_client.system.audit_logs.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncJocall3) -> None:
        async with async_client.system.audit_logs.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
