...
class TestTransactions:
    ...
    def test_method_send_crypto(self, client: Jocall3) -> None:
        ...
        assert_matches_type(TransactionSendCryptoResponse, transaction, path=["response"])

    @parametrize
    def test_raw_response_send_crypto(self, client: Jocall3) -> None:
        response = client.web3.transactions.with_raw_response.send_crypto(
            token="token",
            amount="amount",
            to="to",
        )
    ...
    @parametrize
    def test_streaming_response_send_crypto(self, client: Jocall3) -> None:
        with client.web3.transactions.with_streaming_response.send_crypto(
            token="token",
            amount="amount",
            to="to",
        ) as response:
...
class TestAsyncTransactions:
    ...
    @parametrize
    async def test_method_send_crypto(self, async_client: AsyncJocall3) -> None:
        transaction = await async_client.web3.transactions.send_crypto(
            token="token",
            amount="amount",
            to="to",
        )
    ...
    @parametrize
    async def test_raw_response_send_crypto(self, async_client: AsyncJocall3) -> None:
        response = await async_client.web3.transactions.with_raw_response.send_crypto(
            token="token",
            amount="amount",
            to="to",
        )
    ...
    @parametrize
    async def test_streaming_response_send_crypto(self, async_client: AsyncJocall3) -> None:
        async with async_client.web3.transactions.with_streaming_response.send_crypto(
            token="token",
            amount="amount",
            to="to",
        ) as response:
