...
class TestPredictions:
    ...
    @parametrize
    def test_method_retrieve_inflation_forecast(self, client: Jocall3) -> None:
        prediction = client.ai.oracle.predictions.retrieve_inflation_forecast()
        assert_matches_type(PredictionRetrieveInflationForecastResponse, prediction, path=["response"])

    @parametrize
    def test_method_retrieve_inflation_forecast_with_all_params(self, client: Jocall3) -> None:
        prediction = client.ai.oracle.predictions.retrieve_inflation_forecast(
            region="region",
        )
        assert_matches_type(PredictionRetrieveInflationForecastResponse, prediction, path=["response"])
    ...
    @parametrize
    def test_raw_response_retrieve_inflation_forecast(self, client: Jocall3) -> None:
        response = client.ai.oracle.predictions.with_raw_response.retrieve_inflation_forecast()
    ...
    @parametrize
    def test_streaming_response_retrieve_inflation_forecast(self, client: Jocall3) -> None:
        with client.ai.oracle.predictions.with_streaming_response.retrieve_inflation_forecast() as response:
...
class TestAsyncPredictions:
    ...
    @parametrize
    async def test_method_retrieve_inflation_forecast(self, async_client: AsyncJocall3) -> None:
        prediction = await async_client.ai.oracle.predictions.retrieve_inflation_forecast()
        assert_matches_type(PredictionRetrieveInflationForecastResponse, prediction, path=["response"])

    @parametrize
    async def test_method_retrieve_inflation_forecast_with_all_params(self, async_client: AsyncJocall3) -> None:
        prediction = await async_client.ai.oracle.predictions.retrieve_inflation_forecast(
            region="region",
        )
        assert_matches_type(PredictionRetrieveInflationForecastResponse, prediction, path=["response"])
    ...
    @parametrize
    async def test_raw_response_retrieve_inflation_forecast(self, async_client: AsyncJocall3) -> None:
        response = await async_client.ai.oracle.predictions.with_raw_response.retrieve_inflation_forecast()
    ...
    @parametrize
    async def test_streaming_response_retrieve_inflation_forecast(self, async_client: AsyncJocall3) -> None:
        async with async_client.ai.oracle.predictions.with_streaming_response.retrieve_inflation_forecast() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
