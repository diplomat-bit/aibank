...
class TestAgent:
    ...
    @parametrize
    def test_method_retrieve_prompts(self, client: Jocall3) -> None:
        agent = client.ai.agent.retrieve_prompts()
        assert_matches_type(AgentRetrievePromptsResponse, agent, path=["response"])

    @parametrize
    def test_raw_response_retrieve_prompts(self, client: Jocall3) -> None:
        response = client.ai.agent.with_raw_response.retrieve_prompts()
    ...
    @parametrize
    def test_streaming_response_retrieve_prompts(self, client: Jocall3) -> None:
        with client.ai.agent.with_streaming_response.retrieve_prompts() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncAgent:
    ...
    @parametrize
    async def test_method_retrieve_prompts(self, async_client: AsyncJocall3) -> None:
        agent = await async_client.ai.agent.retrieve_prompts()
        assert_matches_type(AgentRetrievePromptsResponse, agent, path=["response"])

    @parametrize
    async def test_raw_response_retrieve_prompts(self, async_client: AsyncJocall3) -> None:
        response = await async_client.ai.agent.with_raw_response.retrieve_prompts()
    ...
    @parametrize
    async def test_streaming_response_retrieve_prompts(self, async_client: AsyncJocall3) -> None:
        async with async_client.ai.agent.with_streaming_response.retrieve_prompts() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
