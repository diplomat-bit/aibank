...
```sh
$ pip install git+ssh://git@github.com/diplomat-bit/ai_banking.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/diplomat-bit/ai_banking/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
